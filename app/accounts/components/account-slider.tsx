...
export default function accountSlider({onChange }) {
  ...
  const handleSlideChange = (swiper) => {
    const account = purseListWithNew[swiper.realIndex];
  ...
  return (
    ...
    >
      {purseListWithNew.map((account, i) => (
        <SwiperSlide key={account.id} className="!max-w-[340px]">
          <div
                ...
                <div className="my-1 flex">
                  <div className="flex flex-1 flex-col justify-around gap-4">
                    ...
                    <Image
                        src="/images/logo.png"
                        alt="Logo"
                        width={125}     // عرض ثابت بده
                        height={75}    // ارتفاع ثابت بده
